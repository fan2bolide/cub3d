...
/*   Updated: 2023/12/19 09:36:12 by bajeanno         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			cub_portal_texture_put(int x, t_cub *cub, \
										t_position ray_collision);
void			cub_glass_texture_put(int x, t_cub *cub, \
										t_position ray_collision);

int				get_wall_height(t_cub *cub, double wall_distance, \
													double ray_angle);
